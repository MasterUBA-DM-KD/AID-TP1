...
> Únicamente se definió este par de rangos ya que `Q1`, `Q2`, `Q3` de la variable en cuestión corresponden al valor de `-1` (ver análisis descriptivo).
